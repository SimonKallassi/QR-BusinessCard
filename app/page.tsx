...
const t = {
  en: {
    label: "CEO & Owner",
    industries: "Plastics \u00B7 Packaging \u00B7 Trading",
    miroDesc: "Plastics Manufacturing",
    detudoDesc: "Flexible Packaging Manufacturing",
    szsDesc: "International Trading",
    searchWechat: "Search this number to add me",
    ...
    <>
      ...
      <div className="hero">
        <div className="hero-inner">
          ...
          <div className="hero-role">{s.industries}</div>
        </div>
      </div>
      ...
      <div className="content">
        ...
        <div className="ventures">
          <div className="venture">
            ...
            <div className="venture-body">
              ...
              <div className="venture-desc">{s.miroDesc}</div>
              <a href="https://miroplastic.com" target="_blank" rel="noopener" className="venture-link">
                miroplastic.com
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M7 17L17 7M17 7H7M17 7v10" /></svg>
              </a>
            </div>
          </div>
          ...
          <div className="venture">
            ...
            <div className="venture-body">
              ...
              <div className="venture-desc">{s.detudoDesc}</div>
          ...
          <div className="venture">
            ...
            <div className="venture-body">
              ...
              <div className="venture-desc">{s.szsDesc}</div>
            </div>
          </div>
        </div>
        ...
        <div className="contact-block">
          <a href="tel:+9613776882" className="phone-row">+961 3 776 882</a>

          <div className="channels">
            <a href="https://wa.me/9613776882" target="_blank" rel="noopener" className="channel-pill channel-pill--wa">
          ...
          <a href="mailto:marwan@miroplastic.com" className="email-row">marwan@miroplastic.com</a>
        ...
        <div className="colophon">
          <div className="colophon-cities">
            {lang === "en" ? (
              <>Beirut &middot; Luanda<br />Damascus &middot; Lisbon</>
            ) : (
              <>{"\u8D1D\u9C81\u7279"} &middot; {"\u7F57\u5B89\u8FBE"}<br />{"\u5927\u9A6C\u58EB\u9769"} &middot; {"\u91CC\u65AF\u672C"}</>
            )}
          </div>
          ...
          <button
            ...
            onClick={(e) => {
              ...
              navigator.clipboard.writeText("+9613776882").then(() => {
                ...
                setTimeout(() => { btn.textContent = s.copyNumber; }, 2000);
              });
            }}
          >
            {s.copyNumber}
          </button>
          <button className="modal-close" type="button">{s.close}</button>
        </div>
      </div>
    </>
  );
